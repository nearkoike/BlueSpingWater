...
<body>
      ...
      <div class="row gy-5" data-aos="fade-in">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center text-center text-lg-start">
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="#portfolio" class="btn-get-started">Order Now!</a>
  ...
  <main id="main">
    ...
    <!-- ======= Stats Counter Section this is a preview of showing of total orders ======= -->
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-lg-6">
            ...
            <div class="stats-item d-flex align-items-center">
              ...
              <p><strong>Products Sold</strong> Alkaline,Purified,Mineral Water</p>
            </div><!-- End Stats Item -->

            <div class="stats-item d-flex align-items-center">
              <span data-purecounter-start="0" data-purecounter-end="521" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong>Partners</strong> adipisci atque cum quia aut</p>
            </div><!-- End Stats Item -->
    ...
    <!-- ======= Testimonials Section  this is for future purposes for reviews this is just a preview======= -->
        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order" data-aos="fade-up" data-aos-delay="100">
          ...
          <div>
            <ul class="portfolio-flters">
              ...
              <li data-filter=".filter-alkaline">Alkaline</li>
              <li data-filter=".filter-purified">Purified</li>
              <li data-filter=".filter-mineral">Mineral</li>
          ...
          @foreach ($products as $product)
            <div class="col-xl-4 col-md-6 portfolio-item filter-{{ $product->type }}">
              <div class="portfolio-wrap">
                <a href="{{ asset('assets/img/portfolio/app-1.jpg') }}" data-gallery="portfolio-gallery-app" class="glightbox"><img src="{{ $product->image }}" class="img-fluid" alt=""></a>
                ...
                <h4><a href="portfolio-details.html" title="More Details">{{ $product->name }}</a></h4>
                  ...
                  <hr>
                  <h4><a href="/cart/{{ $product->id }}"  class="fa fa-shopping-cart" style="font-size:30px;color:sky-blue"></a>  P {{ $product->price }} 
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Contact</h2>
          <p>Suggestion and feeedback are appreciated. Want partnership? Send us a message.</p>
        </div>
          ...
          <div class="col-lg-4">
            ...
            <div class="info-container d-flex flex-column align-items-center justify-content-center">
              <div class="info-item d-flex">
                ...
                <div>
                  <h4>Location:</h4>
                  <p>Boundary, 331 First, Marilao, 3019 Bulacan</p>
                </div>
              </div><!-- End Info Item -->
